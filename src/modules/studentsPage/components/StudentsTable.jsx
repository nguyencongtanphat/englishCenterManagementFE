            ...
            <tbody style={{backgroundColor: "white"}} onClick={routeChange}>
                {
                    std.map(_std => <tr key={_std.id}>
                        <td>
                            <Container>
                                <Row>
                                    ...
                                    <Col><b>{_std.name}</b><br/><label style={{color: "#6B7280"}}>{ _std.mshv}</label></Col>
                                </Row>
                            </Container>
                        </td>
                        ...
                        <td>{ _std.phone }</td>
                        <td>{ _std.attendent }%<br/><label style={{color: "#6B7280"}}>Present: 20/20</label></td>
                        <td>{ _std.test }%<br/><label style={{color: "#6B7280"}}>Score: 650/700</label></td>
                        <td>{ _std.homework }%<br/><label style={{color: '#6B7280'}}>Completed: 20/30</label></td>
